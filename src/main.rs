...
const TITLE: &str = "RustyTag";

fn main()
{
    unsafe { ffi::SetConfigFlags(ConfigFlag::FLAG_WINDOW_HIGHDPI as u32); }
    ...
    let mut player: Player = Player::new(Vector2 {x: 0.0, y: 0.0}, 5.0, 20.0, Color::WHITE);
